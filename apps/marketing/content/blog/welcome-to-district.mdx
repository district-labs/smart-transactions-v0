...
Signed and broadcast to the network in real-time. Requiring users to be available 24/7 or even worse share their private keys with an external service, if they want to employ an advanced onchain transaction execution strategy.
