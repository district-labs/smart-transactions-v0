...
>
  <div className="grid lg:grid-cols-12 gap-x-10 max-w-screen-2xl mx-auto">
    <div className="col-span-5 flex flex-col justify-center">
      ...
      <Balancer className="my-2 max-w-3xl text-lg text-muted-foreground sm:text-xl">
        Create a portfolio of automated trading strategies without writing
        a line of code.
      </Balancer>
      <div className="">
  ...
  return (
    <section>
      <div className="container mt-20">
        ...
        <div className='grid gap-x-10 gap-y-32 lg:grid-cols-12 mt-48'>
