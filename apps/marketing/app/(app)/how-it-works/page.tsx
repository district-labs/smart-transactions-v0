  ...
  return (
    <>
      <div className="content container max-w-screen-md pt-10 lg:pt-20 pb-32">
        ...
        <p>
          District Finance is a <span className='font-bold'>DeFi centric application</span> and <span className='font-bold'>smart transaction protocol</span>.
        </p>
        <p>
        ...
        <hr className='my-10' />
        <h3 className='font-bold text-3xl'>📜 Smart Transactions</h3>
        <p>
          <span className='font-bold'>Smart transactions</span> are distinct from <span className='italic'>normal transactions</span>.
        </p>
        <p>
        ...
        <p>
        <span className='font-bold'>A smart transaction can read current and historic state of a blockchain before being executed.</span> Greatly expanding the rules and conditions governing for when a transaction becomes valid i.e. executable.
        </p>
        <p>
        <p className=''>
        ...
        <hr className='my-10' />
        <h3 className='font-bold text-3xl'>🔐 Intent Modules</h3>
        <p className=''>
          At the heart of Smart Transactions are <span className='font-bold'>intent modules</span>.
        </p>
        <p className=''>
          Intent modules are smart contracts that constrain a smart transaction.
        </p>
        <h3 className='font-bold mt-6 text-lg'>Intent Module Examples</h3>
        ...
        <p className=''>
          For example the <span className='font-medium'>TimestampRangeIntent</span> and <span className='font-medium'>ERC20LimitOrderIntent</span> intent modules can be combined to create a limit order that is only valid between a specific time range.
        </p>
        <p className=''>
          Or <span className='font-medium'>UniswapV3HistoricalTwapPercentageChange</span> and <span className='font-medium'>ERC20SwapSpotPriceExactTokenOut</span> intent modules used to implement an automatic Mean Reversion trading strategy.
        <div className='text-center my-5'>
          <img src='/images/preview-code.png' alt="Player vs Game" className='w-full rounded-xl shadow-md border-2 border-white' />
          <span className='mt-1 text-light text-xs'>TimestampRangeIntent.sol Example Code</span>
        </div>
        </p>
        <hr className='my-10' />
        <h3 className='font-bold text-3xl'>💳 Smart Wallet</h3>
        <p className=''>
          District Finance extends the Safe Multisig Wallet with the Intentify module.
        </p>
        <div className='bg-neutral bg-red-100 p-3 rounded-md my-3'>
          <span className=''>
            Do NOT install the Intentify module on existing Safe Multisig Wallet. <span className='font-bold'>The smart contracts are an ALPHA release</span>. And should not be used with funds you're not willing to lose.
          </span>
        </div>
        <p className=''>
