...
export function useErc721SafeMint<TMode extends WriteContractMode = undefined>(
  ...
  return useContractWrite<typeof erc721ABI, "safeMint", TMode>({
    abi: erc721ABI,
    functionName: "safeMint",
    ...config,
  } as any)
...
export function usePrepareErc721SafeMint(
  config: Omit<
    UsePrepareContractWriteConfig<typeof erc721ABI, "safeMint">,
    "abi" | "functionName"
  > = {} as any
) {
  return usePrepareContractWrite({
    ...
    functionName: "safeMint",
    ...config,
  } as UsePrepareContractWriteConfig<typeof erc721ABI, "safeMint">)
}
...
export function useErc721BatchMetadataUpdateEvent(
  config: Omit<
    UseContractEventConfig<typeof erc721ABI, "BatchMetadataUpdate">,
    "abi" | "eventName"
  > = {} as any
) {
  return useContractEvent({
    ...
    ...config,
  } as UseContractEventConfig<typeof erc721ABI, "BatchMetadataUpdate">)
}
...
export function useErc721MetadataUpdateEvent(
  config: Omit<
    UseContractEventConfig<typeof erc721ABI, "MetadataUpdate">,
    "abi" | "eventName"
  > = {} as any
) {
  return useContractEvent({
    ...
    ...config,
  } as UseContractEventConfig<typeof erc721ABI, "MetadataUpdate">)
}
