...
export function useErc1155Fungible<
  TFunctionName extends "Fungible",
  TSelectData = ReadContractResult<typeof erc1155ABI, TFunctionName>,
>(
  config: Omit<
    UseContractReadConfig<typeof erc1155ABI, TFunctionName, TSelectData>,
...
export function useErc1155NonFungible<
  TFunctionName extends "NonFungible",
  TSelectData = ReadContractResult<typeof erc1155ABI, TFunctionName>,
>(
  config: Omit<
    UseContractReadConfig<typeof erc1155ABI, TFunctionName, TSelectData>,
...
export function useErc1155NonFungible2nd<
  TFunctionName extends "NonFungible2nd",
  TSelectData = ReadContractResult<typeof erc1155ABI, TFunctionName>,
>(
  config: Omit<
    UseContractReadConfig<typeof erc1155ABI, TFunctionName, TSelectData>,
 ...
 */
export function useErc1155Symbol<
 ...
 */
export function useErc1155TotalHolders<
  TFunctionName extends "totalHolders",
  TSelectData = ReadContractResult<typeof erc1155ABI, TFunctionName>,
>(
  config: Omit<
    UseContractReadConfig<typeof erc1155ABI, TFunctionName, TSelectData>,
 ...
 */
export function useErc1155TotalSupply<
...
export function useErc1155Approve<TMode extends WriteContractMode = undefined>(
  ...
  return useContractWrite<typeof erc1155ABI, "approve", TMode>({
    abi: erc1155ABI,
    functionName: "approve",
    ...config,
  } as any)
 ...
 */
export function useErc1155RenounceOwnership<
  TMode extends WriteContractMode = undefined,
>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
  ...
  return useContractWrite<typeof erc1155ABI, "renounceOwnership", TMode>({
    abi: erc1155ABI,
    functionName: "renounceOwnership",
    ...config,
  } as any)
 ...
 */
export function useErc1155TransferOwnership<
  TMode extends WriteContractMode = undefined,
>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
  ...
  return useContractWrite<typeof erc1155ABI, "transferOwnership", TMode>({
    abi: erc1155ABI,
    functionName: "transferOwnership",
    ...config,
  } as any)
...
export function usePrepareErc1155Approve(
  config: Omit<
    UsePrepareContractWriteConfig<typeof erc1155ABI, "approve">,
    "abi" | "functionName"
  > = {} as any
) {
  return usePrepareContractWrite({
    ...
    functionName: "approve",
    ...config,
  } as UsePrepareContractWriteConfig<typeof erc1155ABI, "approve">)
}
...
export function usePrepareErc1155RenounceOwnership(
  config: Omit<
    UsePrepareContractWriteConfig<typeof erc1155ABI, "renounceOwnership">,
    "abi" | "functionName"
  > = {} as any
) {
  return usePrepareContractWrite({
    ...
    functionName: "renounceOwnership",
    ...config,
  } as UsePrepareContractWriteConfig<typeof erc1155ABI, "renounceOwnership">)
}
...
export function usePrepareErc1155TransferOwnership(
  config: Omit<
    UsePrepareContractWriteConfig<typeof erc1155ABI, "transferOwnership">,
    "abi" | "functionName"
  > = {} as any
) {
  return usePrepareContractWrite({
    ...
    functionName: "transferOwnership",
    ...config,
  } as UsePrepareContractWriteConfig<typeof erc1155ABI, "transferOwnership">)
}
 ...
 */
export function useErc1155ApprovalEvent(
  config: Omit<
    UseContractEventConfig<typeof erc1155ABI, "Approval">,
    "abi" | "eventName"
  > = {} as any
) {
  return useContractEvent({
    ...
    eventName: "Approval",
    ...config,
  } as UseContractEventConfig<typeof erc1155ABI, "Approval">)
}
...
export function useErc1155OwnershipTransferredEvent(
  config: Omit<
    UseContractEventConfig<typeof erc1155ABI, "OwnershipTransferred">,
    "abi" | "eventName"
  > = {} as any
) {
  return useContractEvent({
    ...
    ...config,
  } as UseContractEventConfig<typeof erc1155ABI, "OwnershipTransferred">)
}
