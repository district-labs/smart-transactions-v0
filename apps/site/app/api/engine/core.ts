...
export async function simulateMultipleIntentBundleWithMulticall (chainId: number, bundleBatch: IntentBundleExecutionParsed) {
...
export function convertIntentBundleExecutionQueryToMulticall(address: `0x{string}`, intentBatchQuery: SelectAllIntentBatchQuery[]): IntentBundleExecutionParsed[] {
...
function generateHooksForIntentBatch(intentBatch: SelectAllIntentBatchQuery): Hook[] {
