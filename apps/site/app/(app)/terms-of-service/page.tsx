  ...
  return (
    <>
      ...
      <div className="content container mt-4 max-w-screen-md border-t py-4">
        <p>
          <strong>Last updated:</strong> November 8, 2023
        </p>
        <h2
        ...
        <p>
          We are District Labs Inc. (&quot;<strong>Company</strong>,&quot;
          &quot;
          <strong>we</strong>,&quot; &quot;<strong>us</strong>,&quot; &quot;
          <strong>our</strong>&quot;), a company registered in New York, United
          States at 92 E Broadway, Unit 1, New York, NY 10002.
        </p>
        <p>
          We operate the website{" "}
          <a className="text-blue-600" href="https://districtfinance.io">
            https://districtfinance.io
          </a>{" "}
        ...
        <p>
          You can contact us by phone at 720-879-4082, email at{" "}
          <a
            className="text-blue-600"
            href="mailto:&#105;&#110;&#102;&#111;&#64;&#100;&#x69;&#115;&#116;&#x72;&#x69;&#x63;&#116;&#x6c;&#97;&#98;&#x73;&#x2e;&#x63;&#x6f;&#109;"
          >
            &#105;&#110;&#102;&#111;&#64;&#100;&#x69;&#115;&#116;&#x72;&#x69;&#x63;&#116;&#x6c;&#97;&#98;&#x73;&#x2e;&#x63;&#x6f;&#109;
          </a>
          , or by mail to 92 E Broadway, Unit 1, New York, NY 10002, United
          States.
        </p>
        <p>
          These Legal Terms constitute a legally binding agreement made between
          you, whether personally or on behalf of an entity (&quot;
          <strong>you</strong>&quot;), and District Labs Inc., concerning your
        ...
        <h2 className="mt-3 text-2xl font-bold" id="1-our-services">
          1. OUR SERVICES
        </h2>
        <p>
        ...
        <p>
          ...
          &quot;
          <a className="text-blue-600" href="#7-prohibited-activities">
        ...
        <h2 className="mt-3 text-2xl font-bold" id="3-user-representations">
        ...
        <h2 className="mt-3 text-2xl font-bold" id="4-user-registration">
          4. USER REGISTRATION
        </h2>
        <p>
        ...
        <h2 className="mt-3 text-2xl font-bold" id="5-purchases-and-payment">
        ...
        <h2 className="mt-3 text-2xl font-bold" id="6-cancellation">
          6. CANCELLATION
        </h2>
        <p>
        ...
        <p>
          ...
          or call us at 720-879-4082.
        </p>
        <h2 className="mt-3 text-2xl font-bold" id="7-prohibited-activities">
        ...
        <h2
          className="mt-3 text-2xl font-bold"
          id="8-user-generated-contributions"
        >
        ...
        <h2 className="mt-3 text-2xl font-bold" id="9-contribution-license">
        ...
        <h2
          ...
          id="10-third-party-websites-and-content"
        >
        ...
        <h2 className="mt-3 text-2xl font-bold" id="11-services-management">
        ...
        <h2 className="mt-3 text-2xl font-bold" id="12-privacy-policy">
          12. PRIVACY POLICY
        </h2>
        <p>
          ...
          <strong>
            <a
              className="text-blue-600"
              href="https://districtfinance.io/privacy-policy"
            >
              https://districtfinance.io/privacy-policy
            </a>
          </strong>
        ...
        <h2 className="mt-3 text-2xl font-bold" id="13-term-and-termination">
        ...
        <h2
          className="text-2xl font-bold"
          id="14-modifications-and-interruptions"
        >
        ...
        <h2 className="mt-3 text-2xl font-bold" id="15-governing-law">
          15. GOVERNING LAW
        </h2>
        <p>
        ...
        <h2 className="mt-3 text-2xl font-bold" id="16-dispute-resolution">
        ...
        <p>
          ...
          federal courts located in Sussex County, Delaware, and the Parties
        ...
        <h2 className="mt-3 text-2xl font-bold" id="17-corrections">
          17. CORRECTIONS
        </h2>
        <p>
        ...
        <h2 className="mt-3 text-2xl font-bold" id="18-disclaimer">
          18. DISCLAIMER
        </h2>
        <p>
        ...
        <h2
          className="mt-3 text-2xl font-bold"
          id="19-limitations-of-liability"
        >
        ...
        <h2 className="mt-3 text-2xl font-bold" id="20-indemnification">
          20. INDEMNIFICATION
        </h2>
        <p>
        ...
        <h2 className="mt-3 text-2xl font-bold" id="21-user-data">
          21. USER DATA
        </h2>
        <p>
        ...
        <h2
          className="text-2xl font-bold"
          id="22-electronic-communications-transactions-and-signatures"
        >
        ...
        <h2
          className="text-2xl font-bold"
          id="23-california-users-and-residents"
        >
        ...
        <h2 className="mt-3 text-2xl font-bold" id="24-miscellaneous">
          24. MISCELLANEOUS
        </h2>
        <p>
        ...
        <h2 className="mt-3 text-2xl font-bold" id="25-contact-us">
          25. CONTACT US
        </h2>
        <p>
        ...
        <p>
          <strong>District Labs Inc.</strong>
        </p>
        <p>92 E Broadway, Unit 1</p>
        <p>New York, NY 10002</p>
        <p>United States</p>
        <p>
          <strong>Phone:</strong> 720-879-4082
        </p>
        <p>
          <strong>Email:</strong>{" "}
          <a
