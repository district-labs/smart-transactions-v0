...
import { StrategyMeanReversionBuy } from "@district-labs/intentify-strategy-react"
...
export type FormStrategyMeanReversionBuy = React.HTMLAttributes<HTMLElement> & {
  strategyId: string
  overrideValues?: any
}

export function FormStrategyMeanReversionBuy({
  strategyId,
  overrideValues,
      ...
      <StrategyMeanReversionBuy
        ...
        config={{
          ...
          tokenInAndAmount: {
            ...
            description: "The token and amount you want to receive.",
...
export default FormStrategyMeanReversionBuy
