...
import { StrategyAutomaticLending } from "@district-labs/intentify-strategy-react"
...
export type FormStrategyAutomaticLending = React.HTMLAttributes<HTMLElement> & {
  strategyId: string
  overrideValues?: any
}

export function FormStrategyAutomaticLending({
  strategyId,
  overrideValues,
}: FormStrategyAutomaticLending) {
      ...
      <StrategyAutomaticLending
        ...
        config={{
          ...
          tokenOut: {
            label: "Supply",
            classNameLabel: "text-muted-background",
            description: "Token to supply to the Aave3 Money Market",
...
export default FormStrategyAutomaticLending
