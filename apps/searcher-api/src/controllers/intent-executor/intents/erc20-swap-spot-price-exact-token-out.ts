...
interface Erc20SwapSpotPriceExactTokenOut {
  tokenOut: Address
  tokenIn: Address
...
export async function getHookErc20SwapSpotPriceExactTokenOut(
  inputs: Erc20SwapSpotPriceExactTokenOut,
  ...
  const tokenInAmount =
    (tokenOutAmount *
      ...
      10n ** (tokenInDecimals - tokenOutDecimals)) /
    PRICE_FEED_DECIMALS
