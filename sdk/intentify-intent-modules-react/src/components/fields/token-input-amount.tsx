...
export function TokenInputAmount({
  amount,
  setAmount,
  selectedToken,
  setSelectedToken,
  ...
  return (
    <div className="group relative flex items-center justify-between gap-2 rounded-md border py-1">
      <input
        id="amount"
        type="number"
        className="placeholder:text-muted-foreground block w-full bg-transparent px-3 py-1 text-sm font-medium focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 dark:bg-transparent"
        placeholder="0.0"
        value={amount}
