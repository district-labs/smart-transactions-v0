...
//      * - In order to execute a buy order, te last parameter of the `encode` function, the `isBuy` parameter, must be
// set
//      * to `true`.
//      */
...
//             abi.encodeWithSignature("transferFrom(address,address,uint256)", _whaleUSDC, address(_safeCreated),
// 1300e6);
