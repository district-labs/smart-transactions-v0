...
contract MockAaveLeverageLongIntentTest is AaveLeverageLongIntentTest {
    ...
    {
        return _calculatePayout(swapType, price, supplyAssetDecimals, borrowAssetDecimals, supplyAmount, borrowAmount);
    }
}
...
contract AaveLeverageLongIntentTest is SafeTestingUtils {
    ...
    function test_AaveLeverageLongIntent_calculatePayout_Success() external {
        ...
        uint256 amount = calculatePayout(SWAP_TYPE, PRICE, TOKEN_A_DECIMALS, TOKEN_B_DECIMALS, TOKEN_A_AMOUNT, TOKEN_B_AMOUNT, FEE);
