...
bytes32 constant DIMENSIONALNONCE_TYPEHASH = keccak256("DimensionalNonce(uint128 nonce,uint128 queue)");
...
bytes32 constant INTENTBATCH_TYPEHASH = keccak256("IntentBatch(DimensionalNonce nonce,Intent[] intents)DimensionalNonce(uint128 nonce,uint128 queue)Intent(address root,address target,bytes data)");
...
bytes32 constant INTENTBATCHEXECUTION_TYPEHASH = keccak256("IntentBatchExecution(IntentBatch batch,Signature signature,Hook[] hooks)DimensionalNonce(uint128 nonce,uint128 queue)Hook(address target,bytes data)Intent(address root,address target,bytes data)IntentBatch(DimensionalNonce nonce,Intent[] intents)Signature(bytes32 r,bytes32 s,uint8 v)");
