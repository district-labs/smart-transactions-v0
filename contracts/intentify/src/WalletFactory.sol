...
contract WalletFactory is SafeProxyFactory {
    function getDeterministicWalletAddress(address _singleton, address owner, uint256 saltNonce) public view returns (address proxy) {
    ...
    function createDeterministicWallet(address _singleton, address owner, uint256 saltNonce) public returns (SafeProxy proxy) {
